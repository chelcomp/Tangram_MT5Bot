...
//|                                                                  |
//+------------------------------------------------------------------+
double zCurrentDayNetProfit() //ulong magic_number)
  {
...
//+------------------------------------------------------------------+
ENUM_DEAL_TYPE zTodayLastDealEntryType()//(ulong magic_number)
  {
   int history_deals_total = zTodayDealsTotal();

   if(history_deals_total > 1)
     {
      //-- Run backward the History until to get a deal buy or sell
